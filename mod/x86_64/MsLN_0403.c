...
extern Memb_func* memb_func;
 ...
 "setdata_MsLNdebug", _hoc_setdata,
 "rates_MsLNdebug", _hoc_rates,
 "vtrap_MsLNdebug", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_MsLNdebug
...
#define _gth 0
#define htau_MsLNdebug _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_MsLNdebug _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_MsLNdebug _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_MsLNdebug _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_MsLNdebug _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_MsLNdebug _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_MsLNdebug
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_MsLNdebug", 0, 1e+09,
 "gkbar_MsLNdebug", 0, 1e+09,
 "gnabar_MsLNdebug", 0, 1e+09,
 "usetable_MsLNdebug", 0, 1,
 0,0,0
};
 ...
 "htau_MsLNdebug", "ms",
 "ntau_MsLNdebug", "ms",
 "gnabar_MsLNdebug", "S/cm2",
 "gkbar_MsLNdebug", "S/cm2",
 "gl_MsLNdebug", "S/cm2",
 "el_MsLNdebug", "mV",
 "gna_MsLNdebug", "S/cm2",
 "gk_MsLNdebug", "S/cm2",
 ...
 "minf_MsLNdebug", &minf_MsLNdebug,
 "hinf_MsLNdebug", &hinf_MsLNdebug,
 "ninf_MsLNdebug", &ninf_MsLNdebug,
 "mtau_MsLNdebug", &mtau_MsLNdebug,
 "htau_MsLNdebug", &htau_MsLNdebug,
 "ntau_MsLNdebug", &ntau_MsLNdebug,
 "usetable_MsLNdebug", &usetable_MsLNdebug,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 7);
 	...
 	ivoc_help("help ?1 MsLNdebug /home/park/Programming/hoc/Belmabrouk/mod/x86_64/MsLN_0403.mod\n");
...
static int _reset;
static char *modelname = "Belmabrouk et al. 2011 LN";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _lq10 = pow( 3.0 , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   _lalpha = 0.32 * vtrap ( _threadargscomma_ - ( _lv + 54.0 ) , 4.0 ) ;
   _lbeta = 0.28 * vtrap ( _threadargscomma_ ( _lv + 27.0 ) , 5.0 ) ;
   _lsum = _lalpha + _lbeta ;
   mtau = 1.0 / _lsum ;
   minf = _lalpha / _lsum ;
   ma = _lalpha ;
   mb = _lbeta ;
   _lalpha = 0.032 * vtrap ( _threadargscomma_ - ( _lv + 52.0 ) , 5.0 ) ;
   _lbeta = 0.5 * exp ( - ( _lv + 57.0 ) / 40.0 ) ;
   _lsum = _lalpha + _lbeta ;
   ntau = 1.0 / _lsum ;
   ninf = _lalpha / _lsum ;
   na = _lalpha ;
   nb = _lbeta ;
   _lalpha = 0.128 * exp ( - ( _lv + 50.0 ) / 18.0 ) ;
   _lbeta = 4.0 / ( 1.0 + exp ( - ( _lv + 27.0 ) / 5.0 ) ) ;
   _lsum = _lalpha + _lbeta ;
   htau = 1.0 / _lsum ;
   hinf = _lalpha / _lsum ;
   ha = _lalpha ;

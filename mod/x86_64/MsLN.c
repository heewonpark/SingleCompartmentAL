...
extern Memb_func* memb_func;
 ...
 "setdata_MsLN", _hoc_setdata,
 "rates_MsLN", _hoc_rates,
 "vtrap_MsLN", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_MsLN
...
#define _gth 0
#define htau_MsLN _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_MsLN _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_MsLN _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_MsLN _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_MsLN _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_MsLN _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_MsLN
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 7);
 	...
 	ivoc_help("help ?1 MsLN /home/park/github/SingleCompartmentAL/mod/x86_64/MsLN.mod\n");
